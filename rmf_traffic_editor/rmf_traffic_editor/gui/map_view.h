...
private:
  QString api_key = "YOUR_API_KEY";                   // Google Maps API 키
  QString session_token = "YOUR_SESSION_TOKEN_KEY";   // Google Maps Session 토큰 키
  QString fetchSessionToken(const QString& api_key);  // Google Maps Session 토큰 요청 함수
