...
{
  QNetworkRequest request(QUrl("https://tile.googleapis.com/v1/createSession?key=AIzaSyAZg6TUuScLwWKhTkIqQChaoUhi5RcWQX0"));
  // QNetworkRequest request(QUrl("https://tile.googleapis.com/v1/createSession?key=AIzaSyDAuxzoPOr1YsFbou68WVi6fdOTDzDMcfA"));
...
std::string TileClient::googleMapsTileURL(const TileId &tile_id, std::string const &session_token)
{
  return "https://tile.googleapis.com/v1/2dtiles/" +
        ...
        //  "?session=" + session_token + "&key=AIzaSyDAuxzoPOr1YsFbou68WVi6fdOTDzDMcfA";
         "?session=" + session_token + "&key=AIzaSyAZg6TUuScLwWKhTkIqQChaoUhi5RcWQX0";
}
